...
post_folder_beta_print=            '/post_two_par_print_beta'
post_folder_beta_print10=            '/post_two_par_print_beta10'
post_folder_inclusion=            '/post_two_par_inclusion'
post_folder_nobeta=            '/post_two_par_nobeta'
...
for i in range(c.size):
    ...
    force_beta_print[i]=np.loadtxt(file_location_beta_print, skiprows=10, usecols=4)

    file_location_beta_print10= (simulation_folder + post_folder_beta_print10 + f"/dump_{sep_file}_2.liggghts")
    force_beta_print10[i]=np.loadtxt(file_location_beta_print10, skiprows=10, usecols=4)

    file_location_inclusion= (simulation_folder + post_folder_inclusion+ f"/dump_{sep_file}_2.liggghts")
    force_inclusion[i]=np.loadtxt(file_location_inclusion, skiprows=10, usecols=4)


    file_location_nobeta= (simulation_folder + post_folder_nobeta+ f"/dump_{sep_file}_2.liggghts")
    force_nobeta[i]=np.loadtxt(file_location_nobeta, skiprows=10, usecols=4)
